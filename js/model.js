...
(function() {
  var Model, Player, Save, Settings, Snapshot, Statistic, levels, loadByStructure, observer, penalties_list, saveByStructure, settingsDesc, settingsFields, storage,
  ...
  observer.unobserve = function(object, property) {
    ...
    if (this._observeHandlers[property].lenght === 0) {
      return delete this._observeHandlers[property];
    }
  };
  ...
  Statistic = (function() {
    function Statistic(_at_players) {
      ...
      this.observer = Observer(this.players);
      this.stats = {
        "all_damage": {
    ...
    Statistic.prototype._bind_damage = function() {
      var player_update;
      return player_update = (function(_this) {
        return function() {
          var player, _results;
          _results = [];
          for (player in _this.players) {
            _this.observer.unobserve(player, "health");
            _results.push(_this.observer.observe(player, "health", function(type, oldValue, newValue) {
              var dmg;
