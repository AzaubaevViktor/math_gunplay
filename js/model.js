...
(function() {
  var Model, Player, Save, Settings, Snapshot, Statistic, levels, loadByStructure, observer, penalties_list, saveByStructure, settingsDesc, storage,
  ...
  Settings = (function() {
    ...
    function Settings(_at__settingsDesc) {
      var k, v, _ref;
      this._settingsDesc = _at__settingsDesc;
        ...
        if ("length" !== id) {
          _results.push(observer.observe(player, "health", (function(_this) {
            return function(type, oldValue, newValue) {
              ...
              return console.log(player + " Нанесли " + dmg + " урона");
            };
          })(this)));
        } else {
  ...
  Model = (function() {
    function Model() {
      ...
      this.settings = new Settings(settingsDesc);
